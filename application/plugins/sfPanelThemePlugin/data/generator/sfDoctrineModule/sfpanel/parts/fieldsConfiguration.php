...
<?php unset($this->config['new']['display']) ?>
  ...
  {
    return '<?php echo $this->escapeString(isset($this->config['filter']['title']) ? $this->config['filter']['title'] : sfInflector::humanize($this->getModuleName()).' Filter') ?>';
<?php unset($this->config['filter']['title']) ?>
  }
