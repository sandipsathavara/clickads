 ...
 */
class sfWidgetFormPostTextareaTinyMCE extends sfWidgetFormTextarea
{
  /**
   * Constructor.
   *
...
<script type="text/javascript">
  tinyMCE.init({
	...
	// Theme options
	theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,bullist,numlist,|,undo,redo|,search,replace",
