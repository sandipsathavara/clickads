        ...
        return $(this).each(function(i) {
            ...
            if (!s.attr('multiple')) {
                ...
                c.children().before('<div class="cmf-skinned-text">&nbsp;</div>').each(function() {
                    var temp = this.options[this.selectedIndex].innerHTML;
                    if (this.selectedIndex >= 0) $(this).prev().text(temp.replace("&nbsp;", ""))
                });
                ...
                c.children().click(function() {
                    t.text( (this.options.length > 0 && this.selectedIndex >= 0 ? this.options[this.selectedIndex].innerHTML.replace("&nbsp;&nbsp;&nbsp;&nbsp;", "") : '') );
                });
